...
API_ID = int(environ.get('API_ID', '2743742'))
API_HASH = environ.get('API_HASH', '8fdbb877c32f98ce91c9b919cc9a2a79')
...
LOG_CHANNEL = int(environ.get('LOG_CHANNEL', '-1001691440578'))
ADMINS = [int(admin) if id_pattern.search(admin) else admin for admin in environ.get('ADMINS', '656059661').split()]
CHANNELS = [int(ch) if id_pattern.search(ch) else ch for ch in environ.get('CHANNELS', '-1002419475696').split()]
...
auth_channel = environ.get('AUTH_CHANNEL', '-1001597602551') # give your force subscribe channel id here else leave it blank
AUTH_CHANNEL = int(auth_channel) if auth_channel and id_pattern.search(auth_channel) else None
reqst_channel = environ.get('REQST_CHANNEL_ID', '-1001691440578')
REQST_CHANNEL = int(reqst_channel) if reqst_channel and id_pattern.search(reqst_channel) else None
support_chat_id = environ.get('SUPPORT_CHAT_ID', '-1002419475696')
SUPPORT_CHAT_ID = int(support_chat_id) if support_chat_id and id_pattern.search(support_chat_id) else None
INDEX_REQ_CHANNEL = int(environ.get('INDEX_REQ_CHANNEL', LOG_CHANNEL))
FILE_STORE_CHANNEL = [int(ch) for ch in (environ.get('FILE_STORE_CHANNEL', '-1001691440578')).split()]
DELETE_CHANNELS = [int(dch) if id_pattern.search(dch) else dch for dch in environ.get('DELETE_CHANNELS', '0').split()]

# MongoDB information
DATABASE_URI = environ.get('DATABASE_URI', "mongodb+srv://crazy:music1@crazy7717.zwonh.mongodb.net/?retryWrites=true&w=majority&appName=crazy7717")
...
OWNER_USERNAME = environ.get('OWNER_USERNAME', 'bhaveshpatel7717') # owner username without @
